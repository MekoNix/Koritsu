...
Отдельно и с 2026-09-04 сильнее прежнего проверяется другое: **слова про вид
работы в пакете нет вовсе** (решение владельца, несущее). Раньше «курсовая» была
...
def test_слова_про_вид_работы_в_пакете_нет():
    """Несущее решение владельца 2026-09-04: Koritsu обрабатывает любой документ.
