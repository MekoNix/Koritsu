...
def test_ссылка_в_никуда_останавливает_сборку_и_называет_блок(doors):
    """Решение владельца 2026-09-04: ссылка на ненумерованный блок — ошибка, а не
    предупреждение, и потому прогон с ней до архива не доходит.
...
def test_потолок_ходов_петли_сценарий_называет_свой(doors):
    """50 ходов (решение владельца 2026-09-04) — своё число, а не унаследованное.
