 ...
 *
 * Проверяются два обещания, на которых держится вся ночь 2:
 *
 * 1. **пока выбора нет, ничего не меняется** — сайт спрашивает личное
 *    пространство ровно тем же запросом, что и до ночи 2; иначе экраны B и C
 *    начали бы ходить в службу вторым маршрутом без всякой на то причины;
