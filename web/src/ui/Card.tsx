 ...
 *
 * Заведены были в области настроек (`features/settings/parts.tsx`), а сюда
 * переехали, когда понадобились второй области: карточку берут и настройки, и
 * админка, а это ровно то определение общего компонента, которое написано в
 * `ui/README.md`.
 *
