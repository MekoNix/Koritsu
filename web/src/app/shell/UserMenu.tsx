 ...
 *
 * Состав меню задан брифом дословно: Настройки, Дашборд, Выйти из аккаунта.
 * Ничего сверх этого сюда не дописывается — «Помощь» и «О программе» разводят
 * короткое меню в свалку, а бриф на этот счёт закрыт.
 *
 * Аватар генеративный, из идентификатора (правило брифа); имя — почта, потому
 * что своего имени у аккаунта в службе нет.
 */
