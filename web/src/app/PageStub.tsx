 ...
 *
 * Нужна на время: каркас обязан собираться и открываться по всем маршрутам до
 * того, как области наполнят содержимым. Каждая заглушка лежит в своём файле
 * области (`features/<область>/…`), и содержимое файла заменяется, не трогая ни
 * роутер, ни соседей.
 *
