 ...
 *
 * **Зачем автоматическая сборка.** Над сайтом работают пять агентов сразу, и
 * общий `ru.json` означал бы пять правок в один файл — то есть конфликт на
 * каждой ночи. Поэтому у каждой области свой файл, а словарь склеивается из
 * каталога через `import.meta.glob`: чтобы завести перевод, достаточно
 * положить `src/i18n/ru/<область>.json`, и ничего больше править не надо.
 *
 ...
 *
 * **Голых русских строк в JSX нет** (правило ночи). Единственные исключения —
