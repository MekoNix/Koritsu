 ...
 *     --------------------------------
 *
 * Решение владельца (§7 решений по API): «ходы агента — только итог и
 * прогресс; инструменты и аргументы наружу не уезжают». Поэтому в потоке
 ...
 * рисовать это нечем. Подробный след остаётся в журнале прогона для владельца.
 *
