 ...
 *
 * Постановка задания берётся у области B (`useEnqueueJob`), пресеты модели — у
 * области C (`useProviders`, `defaultProvider`): второй такой же хук рядом с
 ...
 * сохранено (§7 решений по API). Поэтому после отмены теги проекта
