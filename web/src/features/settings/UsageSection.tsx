 ...
 * задания.
 *
 * Единственное место, где цены и остаток показываются: рядом с кнопками их
 * нет — цена прогона динамическая, и названное до нажатия число было бы
 * обещанием, которого никто не давал. Здесь же они приезжают одним ответом
 * (`GET /api/usage`), поэтому рассогласоваться не могут.
 *
