 ...
 *
 * Лежат здесь, а не в `ui/`, намеренно: всё, что понадобилось одной области,
 * обязано жить в этой области, пока не понадобится второй. Переезд отсюда в
 * `ui/` — правка на пять строк, обратный путь стоит дороже.
 */
