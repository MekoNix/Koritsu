 ...
 * (записка Е.2): у «текстов» это «написано 9 из 12», у «решения» — «шаг 4 из
 * 12», а у первых трёх знаменателя нет вовсе, и там называется действие.
 * Полоска с выдуманным знаменателем врёт, поэтому её здесь нет.
 *
