 ...
 *
 * В сайдбаре пункта нет ни у кого (правка 2 макетов и решение владельца:
 * «тот же SPA по `/admin`, виден только с `is_admin`, плюс белый список IP на
 * Caddy»), поэтому попасть сюда можно только по прямому адресу, а право
