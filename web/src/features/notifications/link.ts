 ...
 * запись в списке просто не кликается. Правило прямое: пункт, ведущий в
 * никуда, — ошибка, а не мелочь.
 */
 ...
 * Артефакты кладёт в `data.artifacts` служба.
 */
