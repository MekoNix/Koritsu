 ...
 *
 * Здесь, а не в `api/types.ts` и не в формах области B: правило
 * `api/README.md` — «формы своих областей описывайте у себя». Карточка проекта
 * и материалы — общие с областью B, поэтому они берутся оттуда
 ...
 * общий случай, а не объединение всех восьми типов: сайт ночи 1 правит текст,
