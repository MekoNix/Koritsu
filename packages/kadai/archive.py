...
код.** Решение владельца 2026-08-31: исполнять код мы не будем никогда
(песочницы не будет, запрет 2026-08-27 цел), а врать о непроверенном нельзя.
Компилируемый исходник без этой строки читается как проверенный — студент
узнает правду на защите, а не от нас. Поэтому опись отказывается собираться,
если строки в тексте нет: это не оформление, а условие честности архива.
...
иначе появляется второй источник правды, студент правит `решение.md`, отчёт
