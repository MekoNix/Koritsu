...
Что тут есть сверх первого бэкенда:
  ...
  * подсчёт токенов до отправки — единственный точный из двух протоколов.
"""
...
class AnthropicBackend(Backend):
    ...
    def _usage_from(self, raw: dict) -> Usage:
        ...
        и здесь. Одно место нормализации на оба протокола.
        """
    ...
    def count_tokens(self, request: Request) -> int:
        """Точный подсчёт до отправки — единственный из двух протоколов (В.3).
