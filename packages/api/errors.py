...
КОДЫ_ОТКАЗОВ: tuple[str, ...] = (
    ...
    "already_member", "asm_chat_failed", "asm_failed", "asm_unavailable",
    "bad_outputs", "bad_template", "board_failed",
    ...
    "method_not_allowed", "model_auth", "model_not_found",
    "model_rate_limit", "model_unreachable",
    "nickname_taken", "no_file", "no_invite",
    ...
    "quota_exceeded", "rate_limited", "run_failed", "run_not_ready",
    "scene_conflict", "scene_stale", "scene_too_big", "source_conflict",
    "source_too_big", "source_too_large", "steps_failed",
