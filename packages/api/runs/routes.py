...
Чужой расход не показывается никому и никак; админке (агент C) для этого
...
Цифры отдаются во **внутренних единицах** (§7: «расход наружу во внутренних
...
Вместе с остатком уезжают и **цены видов заданий** (§12): расход считается за
