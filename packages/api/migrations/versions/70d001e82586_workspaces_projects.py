"""workspaces_projects — зона C: пространства, участники, проекты.
...
руками: их заводит миграция агента B, и две миграции, создающие одну таблицу, —
...
ветвей (нашей и B) до `alembic merge` не определён, и SQLite это переживает:
...
`down_revision` — тот head, что стоял в момент создания (`0001_root`). У B и D
он такой же; три головы сводит агент E одной командой `alembic merge`.
"""
