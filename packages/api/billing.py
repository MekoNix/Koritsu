...
Подписку включает владелец службы в админке; платёжка встанет позже, а endpoint
`POST /billing/webhook` заложен пустым, чтобы она встала без правки модели. До
тех пор ответ — `501 Not Implemented`.
