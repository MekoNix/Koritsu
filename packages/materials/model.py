...
у PDF «страница», у картинки «строка» распознанного текста. Она же попадает в
якорь, чтобы модель могла сослаться на источник словами человека.
"""
...
def anchor(name: str, unit: str, start: int, end: int) -> str:
    ...
    plural = "строки" if unit == UNIT_LINE else "страницы"
